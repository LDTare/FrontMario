  ...
  return (
    <div className="card flex justify-content-center">
      ...
      <Panel header="Recomendaciones" toggleable>
        ...
        <br />
        <p className="m-0" align="justify">1. No dejar abierto una sesión en computadoras extrañas. </p> 
        <p className="m-0" align="justify">2. Siempre cerrar sesión si entra por otro dispositivo. </p> 
        <p className="m-0" align="justify">3. Cualquier anomalía, reportarla con el administrador que tenga cerca. </p>
        <p className="m-0" align="justify">4. No olvidar su contraseña. </p>
        <p className="m-0" align="justify">5. Siempre revisar su correo electrónico. </p>
        <br />
